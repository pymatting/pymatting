...
def main():
    ...
    if 1:
        ...
        def solve_petsc(A, b, atol):
            return solve_petsc_coo(
                A.data, A.row, A.col, b, atol=atol, gamg_threshold=0.1
            )
    ...
    if 0:
        solvers.append(
            ("umfpack", lambda: scipy.sparse.linalg.spsolve(Acsc, b, use_umfpack=True))
        )
    ...
    if 0:
        ...
        def solve_eigen_icholt(A, b, rtol):
            ...
            initial_shift = 2e-4
            return solve_eigen_icholt_coo(
                A.data, A.row, A.col, b, rtol=rtol, initial_shift=initial_shift
            )
